...
public interface ReceiptMessages {
    ...
    String receiptDataDeleted = "Dados do recebimento deletados com sucesso!";
        //Error Messages
    String receiptNotCreated = "Não foi possível cadastrar o recebimento, tente mais tarde";
    String receiptDataNotUpdated = "Não foi possível atualizar os dados do recebimento, tente mais tarde";
    String receiptDataNotDeleted = "Não foi possível deletar os dados do recebimento, tente mais tarde";
